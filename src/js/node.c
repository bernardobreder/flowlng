...
void js_node_head(struct js_node_t* self) {
    ...
    while (node) {
        switch(node->type) {
            case JS_NODE_FUNCTION: js_node_function_head((struct js_node_function_t*) node); break;
            case JS_NODE_CLASS: js_node_class_head((struct js_node_class_t*) node); break;
            case JS_NODE_CONSTRUCTOR: js_node_constructor_head((struct js_node_constructor_t*) node); break;
            case JS_NODE_FIELD: js_node_field_head((struct js_node_field_t*) node); break;
            case JS_NODE_IF: js_node_if_head((struct js_node_if_t*) node); break;
            case JS_NODE_WHILE: js_node_while_head((struct js_node_while_t*) node); break;
            case JS_NODE_RETURN: js_node_return_head((struct js_node_return_t*) node); break;
            case JS_NODE_STMT_EXP: js_node_stmtexp_head((struct js_node_stmtexp_t*) node); break;
            case JS_NODE_VAR_ITEM: js_node_var_item_head((struct js_node_var_item_t*) node); break;
            case JS_NODE_EMPTY: js_node_empty_head((struct js_node_empty_t*) node); break;
            case JS_NODE_BREAK: js_node_break_head((struct js_node_break_t*) node); break;
            case JS_NODE_CONTINUE: js_node_continue_head((struct js_node_continue_t*) node); break;
            case JS_NODE_NULL: js_node_null_head((struct js_node_null_t*) node); break;
            case JS_NODE_ID: js_node_id_head((struct js_node_id_t*) node); break;
            case JS_NODE_STRING: js_node_string_head((struct js_node_string_t*) node); break;
            case JS_NODE_NUM: js_node_num_head((struct js_node_num_t*) node); break;
            case JS_NODE_INT: js_node_int_head((struct js_node_int_t*) node); break;
            case JS_NODE_TRUE: js_node_true_head((struct js_node_true_t*) node); break;
            case JS_NODE_FALSE: js_node_false_head((struct js_node_false_t*) node); break;
            case JS_NODE_THIS: js_node_this_head((struct js_node_this_t*) node); break;
            case JS_NODE_SUPER: js_node_super_head((struct js_node_super_t*) node); break;
            case JS_NODE_ASSIGNMENT: js_node_assignment_head((struct js_node_assignment_t*) node); break;
            case JS_NODE_TERNARY: js_node_ternary_head((struct js_node_ternary_t*) node); break;
            case JS_NODE_OR: js_node_or_head((struct js_node_or_t*) node); break;
            case JS_NODE_AND: js_node_and_head((struct js_node_and_t*) node); break;
            case JS_NODE_BITWISE_OR: js_node_bitwise_or_head((struct js_node_bitwise_or_t*) node); break;
            case JS_NODE_BITWISE_XOR: js_node_bitwise_xor_head((struct js_node_bitwise_xor_t*) node); break;
            case JS_NODE_BITWISE_AND: js_node_bitwise_and_head((struct js_node_bitwise_and_t*) node); break;
            case JS_NODE_EQUAL: js_node_equal_head((struct js_node_equal_t*) node); break;
            case JS_NODE_NOT_EQUAL: js_node_not_equal_head((struct js_node_not_equal_t*) node); break;
            case JS_NODE_LOWER_EQUAL: js_node_lower_equal_head((struct js_node_lower_equal_t*) node); break;
            case JS_NODE_GREATER_EQUAL: js_node_greater_equal_head((struct js_node_greater_equal_t*) node); break;
            case JS_NODE_LOWER_THAN: js_node_lower_than_head((struct js_node_lower_than_t*) node); break;
            case JS_NODE_GREATER_THAN: js_node_greater_than_head((struct js_node_greater_than_t*) node); break;
            case JS_NODE_SHIFT_LEFT: js_node_shift_left_head((struct js_node_shift_left_t*) node); break;
            case JS_NODE_SHIFT_RIGHT: js_node_shift_right_head((struct js_node_shift_right_t*) node); break;
            case JS_NODE_SUM: js_node_sum_head((struct js_node_sum_t*) node); break;
            case JS_NODE_SUB: js_node_sub_head((struct js_node_sub_t*) node); break;
            case JS_NODE_MUL: js_node_mul_head((struct js_node_mul_t*) node); break;
            case JS_NODE_DIV: js_node_div_head((struct js_node_div_t*) node); break;
            case JS_NODE_NOT: js_node_not_head((struct js_node_not_t*) node); break;
            case JS_NODE_NEG: js_node_neg_head((struct js_node_neg_t*) node); break;
            case JS_NODE_PRE_INC: js_node_pre_inc_head((struct js_node_pre_inc_t*) node); break;
            case JS_NODE_PRE_DEC: js_node_pre_dec_head((struct js_node_pre_dec_t*) node); break;
            case JS_NODE_POS_INC: js_node_pos_inc_head((struct js_node_pos_inc_t*) node); break;
            case JS_NODE_POS_DEC: js_node_pos_dec_head((struct js_node_pos_dec_t*) node); break;
            case JS_NODE_GET: js_node_get_head((struct js_node_get_t*) node); break;
            case JS_NODE_ARRAY: js_node_array_head((struct js_node_array_t*) node); break;
            case JS_NODE_CALL: js_node_call_head((struct js_node_call_t*) node); break;
        }
        node = node->next;
    }
}
...
void js_node_body(struct js_node_t* self) {
    ...
    while (node) {
        switch(node->type) {
            case JS_NODE_FUNCTION: js_node_function_body((struct js_node_function_t*) node); break;
            case JS_NODE_CLASS: js_node_class_body((struct js_node_class_t*) node); break;
            case JS_NODE_CONSTRUCTOR: js_node_constructor_body((struct js_node_constructor_t*) node); break;
            case JS_NODE_FIELD: js_node_field_body((struct js_node_field_t*) node); break;
            case JS_NODE_IF: js_node_if_body((struct js_node_if_t*) node); break;
            case JS_NODE_WHILE: js_node_while_body((struct js_node_while_t*) node); break;
            case JS_NODE_RETURN: js_node_return_body((struct js_node_return_t*) node); break;
            case JS_NODE_STMT_EXP: js_node_stmtexp_body((struct js_node_stmtexp_t*) node); break;
            case JS_NODE_VAR_ITEM: js_node_var_item_body((struct js_node_var_item_t*) node); break;
            case JS_NODE_EMPTY: js_node_empty_body((struct js_node_empty_t*) node); break;
            case JS_NODE_BREAK: js_node_break_body((struct js_node_break_t*) node); break;
            case JS_NODE_CONTINUE: js_node_continue_body((struct js_node_continue_t*) node); break;
            case JS_NODE_NULL: js_node_null_body((struct js_node_null_t*) node); break;
            case JS_NODE_ID: js_node_id_body((struct js_node_id_t*) node); break;
            case JS_NODE_STRING: js_node_string_body((struct js_node_string_t*) node); break;
            case JS_NODE_NUM: js_node_num_body((struct js_node_num_t*) node); break;
            case JS_NODE_INT: js_node_int_body((struct js_node_int_t*) node); break;
            case JS_NODE_TRUE: js_node_true_body((struct js_node_true_t*) node); break;
            case JS_NODE_FALSE: js_node_false_body((struct js_node_false_t*) node); break;
            case JS_NODE_THIS: js_node_this_body((struct js_node_this_t*) node); break;
            case JS_NODE_SUPER: js_node_super_body((struct js_node_super_t*) node); break;
            case JS_NODE_ASSIGNMENT: js_node_assignment_body((struct js_node_assignment_t*) node); break;
            case JS_NODE_TERNARY: js_node_ternary_body((struct js_node_ternary_t*) node); break;
            case JS_NODE_OR: js_node_or_body((struct js_node_or_t*) node); break;
            case JS_NODE_AND: js_node_and_body((struct js_node_and_t*) node); break;
            case JS_NODE_BITWISE_OR: js_node_bitwise_or_body((struct js_node_bitwise_or_t*) node); break;
            case JS_NODE_BITWISE_XOR: js_node_bitwise_xor_body((struct js_node_bitwise_xor_t*) node); break;
            case JS_NODE_BITWISE_AND: js_node_bitwise_and_body((struct js_node_bitwise_and_t*) node); break;
            case JS_NODE_EQUAL: js_node_equal_body((struct js_node_equal_t*) node); break;
            case JS_NODE_NOT_EQUAL: js_node_not_equal_body((struct js_node_not_equal_t*) node); break;
            case JS_NODE_LOWER_EQUAL: js_node_lower_equal_body((struct js_node_lower_equal_t*) node); break;
            case JS_NODE_GREATER_EQUAL: js_node_greater_equal_body((struct js_node_greater_equal_t*) node); break;
            case JS_NODE_LOWER_THAN: js_node_lower_than_body((struct js_node_lower_than_t*) node); break;
            case JS_NODE_GREATER_THAN: js_node_greater_than_body((struct js_node_greater_than_t*) node); break;
            case JS_NODE_SHIFT_LEFT: js_node_shift_left_body((struct js_node_shift_left_t*) node); break;
            case JS_NODE_SHIFT_RIGHT: js_node_shift_right_body((struct js_node_shift_right_t*) node); break;
            case JS_NODE_SUM: js_node_sum_body((struct js_node_sum_t*) node); break;
            case JS_NODE_SUB: js_node_sub_body((struct js_node_sub_t*) node); break;
            case JS_NODE_MUL: js_node_mul_body((struct js_node_mul_t*) node); break;
            case JS_NODE_DIV: js_node_div_body((struct js_node_div_t*) node); break;
            case JS_NODE_NOT: js_node_not_body((struct js_node_not_t*) node); break;
            case JS_NODE_NEG: js_node_neg_body((struct js_node_neg_t*) node); break;
            case JS_NODE_PRE_INC: js_node_pre_inc_body((struct js_node_pre_inc_t*) node); break;
            case JS_NODE_PRE_DEC: js_node_pre_dec_body((struct js_node_pre_dec_t*) node); break;
            case JS_NODE_POS_INC: js_node_pos_inc_body((struct js_node_pos_inc_t*) node); break;
            case JS_NODE_POS_DEC: js_node_pos_dec_body((struct js_node_pos_dec_t*) node); break;
            case JS_NODE_GET: js_node_get_body((struct js_node_get_t*) node); break;
            case JS_NODE_ARRAY: js_node_array_body((struct js_node_array_t*) node); break;
            case JS_NODE_CALL: js_node_call_body((struct js_node_call_t*) node); break;
        }
        node = node->next;
    }
}
...
void js_node_exec(struct js_node_t* self, struct js_context_t* context) {
    ...
    while (node) {
        switch(node->type) {
            case JS_NODE_FUNCTION: js_node_function_exec((struct js_node_function_t*) node, context); break;
            case JS_NODE_CLASS: js_node_class_exec((struct js_node_class_t*) node, context); break;
            case JS_NODE_CONSTRUCTOR: js_node_constructor_exec((struct js_node_constructor_t*) node, context); break;
            case JS_NODE_FIELD: js_node_field_exec((struct js_node_field_t*) node, context); break;
            case JS_NODE_IF: js_node_if_exec((struct js_node_if_t*) node, context); break;
            case JS_NODE_WHILE: js_node_while_exec((struct js_node_while_t*) node, context); break;
            case JS_NODE_STMT_EXP: js_node_stmtexp_exec((struct js_node_stmtexp_t*) node, context); break;
            case JS_NODE_VAR_ITEM: js_node_var_item_exec((struct js_node_var_item_t*) node, context); break;
            case JS_NODE_RETURN: js_node_return_exec((struct js_node_return_t*) node, context); break;
            case JS_NODE_EMPTY: js_node_empty_exec((struct js_node_empty_t*) node, context); break;
            case JS_NODE_BREAK: js_node_break_exec((struct js_node_break_t*) node, context); break;
            case JS_NODE_CONTINUE: js_node_continue_exec((struct js_node_continue_t*) node, context); break;
            case JS_NODE_NULL: js_node_null_exec((struct js_node_null_t*) node, context); break;
            case JS_NODE_ID: js_node_id_exec((struct js_node_id_t*) node, context); break;
            case JS_NODE_STRING: js_node_string_exec((struct js_node_string_t*) node, context); break;
            case JS_NODE_NUM: js_node_num_exec((struct js_node_num_t*) node, context); break;
            case JS_NODE_INT: js_node_int_exec((struct js_node_int_t*) node, context); break;
            case JS_NODE_TRUE: js_node_true_exec((struct js_node_true_t*) node, context); break;
            case JS_NODE_FALSE: js_node_false_exec((struct js_node_false_t*) node, context); break;
            case JS_NODE_THIS: js_node_this_exec((struct js_node_this_t*) node, context); break;
            case JS_NODE_SUPER: js_node_super_exec((struct js_node_super_t*) node, context); break;
            case JS_NODE_ASSIGNMENT: js_node_assignment_exec((struct js_node_assignment_t*) node, context); break;
            case JS_NODE_TERNARY: js_node_ternary_exec((struct js_node_ternary_t*) node, context); break;
            case JS_NODE_OR: js_node_or_exec((struct js_node_or_t*) node, context); break;
            case JS_NODE_AND: js_node_and_exec((struct js_node_and_t*) node, context); break;
            case JS_NODE_BITWISE_OR: js_node_bitwise_or_exec((struct js_node_bitwise_or_t*) node, context); break;
            case JS_NODE_BITWISE_XOR: js_node_bitwise_xor_exec((struct js_node_bitwise_xor_t*) node, context); break;
            case JS_NODE_BITWISE_AND: js_node_bitwise_and_exec((struct js_node_bitwise_and_t*) node, context); break;
            case JS_NODE_EQUAL: js_node_equal_exec((struct js_node_equal_t*) node, context); break;
            case JS_NODE_NOT_EQUAL: js_node_not_equal_exec((struct js_node_not_equal_t*) node, context); break;
            case JS_NODE_LOWER_EQUAL: js_node_lower_equal_exec((struct js_node_lower_equal_t*) node, context); break;
            case JS_NODE_GREATER_EQUAL: js_node_greater_equal_exec((struct js_node_greater_equal_t*) node, context); break;
            case JS_NODE_LOWER_THAN: js_node_lower_than_exec((struct js_node_lower_than_t*) node, context); break;
            case JS_NODE_GREATER_THAN: js_node_greater_than_exec((struct js_node_greater_than_t*) node, context); break;
            case JS_NODE_SHIFT_LEFT: js_node_shift_left_exec((struct js_node_shift_left_t*) node, context); break;
            case JS_NODE_SHIFT_RIGHT: js_node_shift_right_exec((struct js_node_shift_right_t*) node, context); break;
            case JS_NODE_SUM: js_node_sum_exec((struct js_node_sum_t*) node, context); break;
            case JS_NODE_SUB: js_node_sub_exec((struct js_node_sub_t*) node, context); break;
            case JS_NODE_MUL: js_node_mul_exec((struct js_node_mul_t*) node, context); break;
            case JS_NODE_DIV: js_node_div_exec((struct js_node_div_t*) node, context); break;
            case JS_NODE_NOT: js_node_not_exec((struct js_node_not_t*) node, context); break;
            case JS_NODE_NEG: js_node_neg_exec((struct js_node_neg_t*) node, context); break;
            case JS_NODE_PRE_INC: js_node_pre_inc_exec((struct js_node_pre_inc_t*) node, context); break;
            case JS_NODE_PRE_DEC: js_node_pre_dec_exec((struct js_node_pre_dec_t*) node, context); break;
            case JS_NODE_POS_INC: js_node_pos_inc_exec((struct js_node_pos_inc_t*) node, context); break;
            case JS_NODE_POS_DEC: js_node_pos_dec_exec((struct js_node_pos_dec_t*) node, context); break;
            case JS_NODE_GET: js_node_get_exec((struct js_node_get_t*) node, context); break;
            case JS_NODE_ARRAY: js_node_array_exec((struct js_node_array_t*) node, context); break;
            case JS_NODE_CALL: js_node_call_exec((struct js_node_call_t*) node, context); break;
        }
        node = node->next;
    }
}
...
void js_node_function_head(struct js_node_function_t* self) {
    js_node_head_typed(self->name);
    js_node_head_typed(self->param);
    js_node_head_typed(self->statement);
}

void js_node_function_body(struct js_node_function_t* self) {
    js_node_body_typed(self->name);
    js_node_body_typed(self->param);
    js_node_body_typed(self->statement);
}
...
void js_node_if_head(struct js_node_if_t* self) {
    js_node_head_typed(self->expression);
    js_node_head_typed(self->statement);
    js_node_head_typed(self->else_statement);
}

void js_node_if_body(struct js_node_if_t* self) {
    js_node_body_typed(self->expression);
    js_node_body_typed(self->statement);
    js_node_body_typed(self->else_statement);
}
...
void js_node_ternary_head(struct js_node_ternary_t* self) {
    js_node_head_typed(self->node);
    js_node_head_typed(self->true_value);
    js_node_head_typed(self->false_value);
}

void js_node_ternary_body(struct js_node_ternary_t* self) {
    js_node_body_typed(self->node);
    js_node_body_typed(self->true_value);
    js_node_body_typed(self->false_value);
}
